          ...
          <div id="datos-entrega" class="<?= $metodoPago === 'entrega' ? '' : 'd-none' ?>">
           ...
           <div class="form-check mt-4">
             ...
             <label class="form-check-label text-soft" for="acepta_terminos_checkout">
               Declaro que he leido y acepto los <a href="#" onclick="event.preventDefault(); event.stopPropagation(); mostrarTerminosModal('acepta_terminos_checkout'); return false;">terminos y condiciones</a> y el tratamiento de los datos necesarios para gestionar este pedido.
             </label>
           </div>
